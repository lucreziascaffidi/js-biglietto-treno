...
const toTravelKM = prompt('Quanti km devi percorrere?');
console.log(
    `
    L'utente deve percorrere ${toTravelKM} KM.
    `
);
...
if (under18) {
    ...
    console.log(
        `
            Il costo totale del biglietto è di ${ticketPriceUnder18.toFixed(2)}€. Scontato del 20% per i minorenni.
        `
    )
    ...
    console.log(
        `
            Il costo totale del biglietto è di ${ticketPriceOver65.toFixed(2)}€. Scontato del 40% per gli over 65.
        `
    )
    ...
    console.log(
        `
            Il costo totale del biglietto è di ${ticketPrice.toFixed(2)}€. L'utente non ha diritto a nessuno sconto.
        `
    )
